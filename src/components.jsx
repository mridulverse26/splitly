  ...
  return (
    <div className="relative">
      <input
        ...
        className={`w-full px-3 py-2.5 pr-10 border border-slate-200 rounded-xl focus:outline-none focus:border-accent-500 focus:ring-2 focus:ring-accent-500/20 ${props.className ?? ""}`}
      />
      <button
        type="button"
